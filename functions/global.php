...
function bbc_global_fields( $wp_customize ) {
  ...
  $wp_customize->add_control( new WP_Customize_Control(
    ...
    array(
      ...
      'description' => __( 'Usage: [bbc_global_email link="true"] or set link to false', 'bbc' ),
  ...
  $wp_customize->add_control( new WP_Customize_Control(
    ...
    array(
      ...
      'description' => __( 'Usage: [bbc_global_phone link="true"] or set link to false', 'bbc' ),
  ...
  $wp_customize->add_control( new WP_Customize_Control(
    ...
    array(
      ...
      'description' => __( 'Usage: [bbc_global_address]', 'bbc' ),
...
if ( ! function_exists('bbc_global_email_shortcode') ) {
  function bbc_global_email_shortcode($atts) {
    ...
    if ( isset($global_email) && $global_email ) {
      if ( $link['link'] ) {
